      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Add the essential details for your journal entry</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Add an image to accompany your journal entry</CardDescription>
          </CardHeader>
          <CardContent>
